...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul style="background-color: #2F4F4F;" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div>
                    <img src="http://127.0.0.1:8000/assets/img/boogie.png" style="height: 40px;width: 100%; radius: 10px;">
                </div>
                <!-- <div class="sidebar-brand-text mx-3">BOOGIE</div> -->
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/selisih">Selisih/Stok</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <!-- <li class="nav-item">
                <a class="nav-link" href="/bahanbaku/create">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Hpp Data</span></a>
            </li> -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="http://127.0.0.1:8000/assets/img/undraw_profile.svg" />
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <div class="dropdown-divider"></div> <!-- Menambah garis pemisah -->
